...
const Navigation = () => {
  return (
    <header id='home'>
        ...
        <nav className='col-two'>
            <ul>
                <li>
                    <a href="https://www.facebook.com/britmikie" target='_blank'>
                ...
                <li>
                    <a href="https://twitter.com/hungry_million?t=cbYFi47SzXk2JYDycNhNqg&s=09" target='_blank'>
